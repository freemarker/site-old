...
[#macro section]
   ...
   [/#if]
   [#assign anchor = .current_node.@anchor!]
   [#assign title = .current_node.@title!]
   ...
   [/#if]
   [#assign sectionNestingLevel = sectionNestingLevel+1]
   [#recurse ]
   [#assign sectionNestingLevel = sectionNestingLevel-1]
[/#macro]
...
[#assign headsection = _recurse, sections = _recurse, page = _recurse]
